...
_git clone https://github.com/chriseppstein/rbenv-each.git ~/.rbenv/plugins/rbenv-each
_git_clone https://github.com/sstephenson/rbenv-gem-rehash.git ~/.rbenv/plugins/rbenv-gem-rehash
_git clone https://github.com/rkh/rbenv-update.git ~/.rbenv/plugins/rbenv-update
